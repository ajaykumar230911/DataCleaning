...
train_x, train_y, test_x, test_y, subject_train and subject_test contain the data from the downloaded files.
data_x, data_y and subject_data merge the previous datasets to further analysis.
features contains the correct names for the data_y dataset, which are applied to the column names stored in
